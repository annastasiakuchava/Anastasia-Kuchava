...
var ExpensesController = function () {
    var _classDecorators = [(0, common_1.Controller)('expenses')];
    ...
    var ExpensesController = _classThis = /** @class */ (function () {
        ...
        ExpensesController_1.prototype.create = function (createExpenseDto) {
            return this.expensesService.create(createExpenseDto);
        };
        ExpensesController_1.prototype.findAll = function (query) {
