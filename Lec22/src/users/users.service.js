...
var UsersService = function () {
    ...
    var UsersService = _classThis = /** @class */ (function () {
        ...
        UsersService_1.prototype.create = function (createUserDto) {
            var newUser = __assign({ id: Date.now() }, createUserDto);
            this.users.push(newUser);
            return newUser;
        };
        UsersService_1.prototype.findAll = function (query) {
            var _a = query.page, page = _a === void 0 ? 1 : _a, _b = query.take, take = _b === void 0 ? 30 : _b, gender = query.gender, email = query.email;
            var filtered = this.users;
            if (gender) {
                filtered = filtered.filter(function (u) { return u.gender === gender; });
            }
            if (email) {
                filtered = filtered.filter(function (u) { return u.email.startsWith(email); });
            }
            var start = (page - 1) * take;
            var end = start + take;
            return {
